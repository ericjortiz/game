...
public class WorldGenerator {
    ...
    /**
     * Places player in the center of a pseudorandom room
     * @param random random to generate
     */
    ...
    /**
     * @param roomNum the room in which the player is placed into at the start of the game
     */
    ...
    /**
     * @param roomNum the room number to place a key into the center of at the start of the game
     */
    ...
    /**
     * @param roomNum the room number to place a teleportation pad into
     */
    ...
    /**
     * @param roomNum the current room number in the ArrayList of rooms
     * @return the updated room number in the ArrayList of rooms
     */
    ...
    /**
     * @return Returns the x position of the first teleportation tile
     */
    ...
    /**
     * @return Returns the x position of the second teleportation tile
     */
    ...
    /**
     * @return Returns the y position of the first teleportation tile
     */
    ...
    /**
     * @return Returns the y position of the second teleportation tile
     */
